...
**경로 링크 (2026-08-29 신설).** 같은 자리에서 둘째 통과 `scripts/link-paths.mjs` 가 본문(코드 글꼴 `.mono` **포함**)의 경로 꼴 낱말
(`docs/handoffs/X.md:900` · `…-design.md:1032` · `HANDOFF-x.md` · `facts/*.md`)을 실제 로컬 파일·폴더의 `file://` 링크로 바꾼다(**새 탭**).
