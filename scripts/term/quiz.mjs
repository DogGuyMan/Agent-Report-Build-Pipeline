 ...
 * `codegraph/run_mode1_5.py` 의 `CHOICES_PER_QUESTION` 과 **같은 값이어야 한다.**
 * 마지막 자리가 "모르겠다" 라는 것이 채점의 전제다 — 그 번호를 고르면 dontKnow 로 센다.
 */
export const CHOICES_PER_QUESTION = 5;

// <include file="docs/codegraph/comments.xml" path="//term[@id='flattenQuestions']"/>
// 문항지를 용어 순 · 문항 순으로 펴고 1부터 번호를 매긴다.
// 쓰는 것: 없음 · 쓰이는 곳: tallySheet
/**
 * 중첩된 문항지를 한 줄로 펴고 `QNum` 을 1부터 매긴다.
 *
 * **`codegraph/run_mode1_5.py` 의 `flatten_questions` 와 같은 순서여야 한다.**
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='choiceNumber']"/>
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='tallySheet']"/>
