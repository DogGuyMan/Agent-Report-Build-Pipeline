// <include file="docs/codegraph/comments.xml" path="//term[@id='scripts/wiki/clang-doc.mjs']"/>
...
// `scripts/python.mjs` 가 파이썬을 찾는 것과 같은 꼴로 **찾아서** 쓴다 — 박지 않는다.
//
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='clangDocCandidates']"/>
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='brewPrefixes']"/>
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='clangDocPath']"/>
// 실제로 쓸 clang-doc 실행 파일 하나를 고른다.
// 쓰는 것: clangDocCandidates, brewPrefixes · 쓰이는 곳: scripts/wiki/clang-doc.mjs
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='clangDocArgs']"/>
