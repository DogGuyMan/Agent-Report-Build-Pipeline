// <include file="docs/codegraph/comments.xml" path="//term[@id='scripts/wiki/compdb.mjs']"/>
// scripts/wiki/compdb.mjs
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='findCompdbs']"/>
 ...
 * 순수 함수라 테스트가 쉽다.
 */
// <include file="docs/codegraph/comments.xml" path="//term[@id='mergeEntries']"/>
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='relativeFiles']"/>
 ...
 */
// <include file="docs/codegraph/comments.xml" path="//term[@id='clangUmlConfig']"/>
...
// <include file="docs/codegraph/comments.xml" path="//term[@id='readAuthorConfig']"/>
