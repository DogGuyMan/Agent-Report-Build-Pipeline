...
// <include file="machine/comments.xml" path="//term[@id='defineTerms']"/>
...
// <include file="machine/comments.xml" path="//term[@id='Glossary']"/>
...
// <include file="machine/comments.xml" path="//term[@id='TermGraph']"/>
