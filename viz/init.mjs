...
// <include file="machine/comments.xml" path="//term[@id='parseSpecFilename']"/>
...
// <include file="machine/comments.xml" path="//term[@id='findSimilar']"/>
...
if (process.argv[1] && process.argv[1].endsWith("init.mjs")) {
  ...
  // <include file="machine/comments.xml" path="//term[@id='init.currentBuilderVersion']"/>
