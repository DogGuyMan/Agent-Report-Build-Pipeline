// <include file="machine/comments.xml" path="//term[@id='collect.mjs']"/>
// 이 Plan 을 읽는 데 필요한 용어를 모으는 스크립트. Mode 1.5 의 1단계다.
// 쓰는 것: term-candidates.json · 쓰이는 곳: 없음
// runner/term/collect.mjs — Mode 1.5 1단계. 이 Plan 을 이해하는 데 필요한 용어를 모은다.
//
// 두 갈래에서 모은다.
...
// <include file="machine/comments.xml" path="//term[@id='escapeRe']"/>
...
// <include file="machine/comments.xml" path="//term[@id='pickTerms']"/>
...
// <include file="machine/comments.xml" path="//term[@id='findNewConcepts']"/>
// Plan 이 새로 만든 개념을 찾는다. 정답이 없으므로 저자가 써야 한다.
// 쓰는 것: WarmUp · 쓰이는 곳: 없음
/**
 * Plan 이 새로 만든 개념을 찾는다. `viz/check.mjs` 의 undefinedTerms 와 같은 세 꼴을 쓴다.
