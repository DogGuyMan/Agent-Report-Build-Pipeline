// <include file="machine/comments.xml" path="//term[@id='runner/wiki/check.mjs']"/>
// 위키 산문의 인용을 검증하는 파일.
// 쓰는 것: 없음 · 쓰이는 곳: 없음
...
if (process.argv[1] && process.argv[1].endsWith("check.mjs")) {
  ...
  const r = spawnSync(pythonPath(ROOT), [join(ROOT, "machine", "verify_citations.py"), ...args], { stdio: "inherit" });
