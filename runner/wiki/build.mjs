// <include file="machine/comments.xml" path="//term[@id='runner/wiki/build.mjs']"/>
...
if (process.argv[1] && process.argv[1].endsWith("build.mjs")) {
  ...
  run(pythonPath(ROOT), [join(ROOT, "viz", "demermaid.py"), P.wiki, "--out", P.built, ...svgDir]);
  ...
  // (🔵 2026-08-29 QtVisionEdit 에서 둘 다 겪었다). viz/build.mjs 가
